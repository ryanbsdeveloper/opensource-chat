...
"}")
        ...
        self.radioButton_java.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/javascript", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_javascript.setIcon(icon3)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/nodejs", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_nodejs.setIcon(icon5)
        ...
        self.radioButton_csharp.setIcon(icon7)
        ...
        self.radioButton_c.setIcon(icon8)
        ...
        self.radioButton_argular.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/css html", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.radioButton_ruby.setIcon(icon12)
        ...
        self.radioButton_swift.setIcon(icon13)
        ...
        self.radioButton_vue.setIcon(icon14)
        ...
        self.radioButton_cmais.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/icons/nenhuma", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_nenhum.setIcon(icon16)
