...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        self.frame.setMinimumSize(QSize(604, 469))
        self.frame.setMaximumSize(QSize(604, 469))
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/c", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_c.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/swift", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_swift.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/ruby", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_ruby.setIcon(icon3)
        ...
        self.radioButton_kotlin.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/java", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_java.setIcon(icon5)
        ...
        self.radioButton_php.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/angular", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_argular.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/python", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_python.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/js", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_javascript.setIcon(icon9)
        ...
        self.radioButton_web.setIcon(icon10)
        ...
        self.radioButton_react.setIcon(icon11)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/node", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_nodejs.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/nehum", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/vue", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_vue.setIcon(icon15)
